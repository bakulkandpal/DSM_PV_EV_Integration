...
charger_power = (240, 120)  # Charger capacity in kW. First and second value denote first and second batch charging power respectively.
num_chargers = 20  # Total number of chargers available at the station.
