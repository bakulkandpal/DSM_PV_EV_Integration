...
plots_pv = True  # Input 'True' if PV generation and its impact on feeder loads is to be shown in Plots, else 'False'.
...
charging_rates = peak_shifting(hourly_data, charger_power, num_buses, buses_time_range, pv_generation_15min)